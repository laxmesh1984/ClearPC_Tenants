...
//			new InheritableThreadLocal<LinkedList<Step>>();
	  private static ThreadLocal stepListThreadLocal =new InheritableThreadLocal<Step>();
	...
	public ExtentCucumberFormatter(File file) {
		...
		setExtentReport();
		//stepListThreadLocal.set(new LinkedList<Object>());
		 stepListThreadLocal.set(new LinkedList<Object>());
	...
	public void step(Step step) 
	{
		...
		((LinkedList<Object>) stepListThreadLocal.get()).add(step);
...
//				Selenium_Functions.extentReportScreenShot();
	...
	public void match(Match match) {
		Step step = (Step) ((LinkedList<Object>) stepListThreadLocal.get()).poll();
		String data[][] = null;
