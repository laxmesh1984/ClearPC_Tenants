...
public class CBS_ClearPC_Locators

{
	...
	public static String  Search_image_d;
	...
	public static String Password_invalid_x;
	public static String Copy_Reset_Message_x;
	public static String Copy_Reset_close_x;
	public static String Delete_x;
	public static String Rename_Alert_pop_x;
	public static String Folder_toggle_x;
	...
	public static String Folder_Filter_x;
	public static String renamed_asset_x;
	public static String Folder_edited_x;
	public static String Fodler_path_x;
	public static String filter_x;
	public static String image_checkbox_x;
	public static String document_checkbox_x;
	public static String Cbs_Folder_x;
	
	public static String Player_Control_Pin_x;
	public static String  Test_Folder_x;
	public static String Turner_Move_Folder_x;
	public static String CBS_LABEL_X;
	public static String Control_Player_x;
	public static String LG_LABEL_X;
	...
	public static String Copy_To_Folder_X;
	...
	public static String  Test_Folder_Created;
	public static String  Turner_Copy_Folder_x;
	...
	public static void getlocators() throws IOException {
		...
		Search_image_d = prop.getProperty("Search_image_d");
		...
		Password_invalid_x = prop1.getProperty("Password_invalid_x");
		Copy_Reset_Message_x = prop1.getProperty("Copy_Reset_Message_x");
		Copy_Reset_close_x = prop1.getProperty("Copy_Reset_close_x");
		...
		CBS_LABEL_X = prop1.getProperty("CBS_LABEL_X");
		LG_LABEL_X = prop1.getProperty("LG_LABEL_X");
		Prod_Logout_x = prop1.getProperty("Prod_Logout_x");
		Folder_toggle_x = prop1.getProperty("Folder_toggle_x");
		...
		Folder_Filter_x = prop1.getProperty("Folder_Filter_x");
		...
		renamed_asset_x = prop1.getProperty("renamed_asset_x");
		...
		Cbs_Folder_x = prop1.getProperty("Cbs_Folder_x");
		...
		Test_Folder_x  = prop1.getProperty("Test_Folder_x");
		...
		Copy_To_Folder_X = prop1.getProperty("Copy_To_Folder_X");
		...
		filter_x = prop1.getProperty("filter_x");
		image_checkbox_x = prop1.getProperty("image_checkbox_x");
		Test_Folder_Created = prop1.getProperty("Test_Folder_Created");
        ...
        Folder_edited_x = prop1.getProperty("Folder_edited_x");
        Fodler_path_x  = prop1.getProperty("Fodler_path_x");
        document_checkbox_x = prop1.getProperty("document_checkbox_x");
        Turner_Copy_Folder_x = prop1.getProperty("Turner_Copy_Folder_x");
        Turner_Move_Folder_x = prop1.getProperty("Turner_Move_Folder_x");
		}
