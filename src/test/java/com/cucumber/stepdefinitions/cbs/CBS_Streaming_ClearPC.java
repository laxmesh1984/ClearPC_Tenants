...
public class CBS_Streaming_ClearPC {
...
@Then("^Validate Advance player functionality$")
public void validate_Advance_player_functionality() throws Throwable {
	CLEAR_User_Function.sleep(1000);
...
@Then("^Validate Information player functionality$")
public void validate_Information_player_functionality() throws Throwable
{
	Thread.sleep(2000);
...
@Then("^Validate Editor player functionality$")
public void validate_Editor_player_functionality() throws Throwable 
{
	Thread.sleep(5000);
	CLEAR_User_Function.Onhover(CBS_ClearPC_Locators.Advance_popup_x);
	Thread.sleep(10000);
	CLEAR_User_Function.click(CBS_ClearPC_Locators.Editor_popup_x);
	Thread.sleep(10000);
	CLEAR_User_Function.Onhover(CBS_ClearPC_Locators.Editor_player_pause_x);
	Thread.sleep(10000);
	CLEAR_User_Function.click(CBS_ClearPC_Locators.Editor_player_stop_x);
	Thread.sleep(10000);
	CLEAR_User_Function.click(CBS_ClearPC_Locators.Editor_player_pause_x);
	Thread.sleep(10000);
	CLEAR_User_Function.click(CBS_ClearPC_Locators.Editor_playerbinbar_x);
	CLEAR_User_Function.sleep(10000);
	CLEAR_User_Function.click(CBS_ClearPC_Locators.Editor_player_close_x);
	CLEAR_User_Function.sleep(5000);
	CLEAR_User_Function.click(CBS_ClearPC_Locators.Edior_saveno_x);
	CLEAR_User_Function.extentReportScreenShot();
